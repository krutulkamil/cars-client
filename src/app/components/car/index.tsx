...
const Car: FunctionComponent<ICarProps> = (props): JSX.Element => {
    const { name, thumbnailScr, dailyPrice, monthlyPrice, gas, mileage, gearType} = props;

    return (
        <CarContainer>
            <CarThumbnail>
                <img src={thumbnailScr} alt="thumbnail" />
            </CarThumbnail>
